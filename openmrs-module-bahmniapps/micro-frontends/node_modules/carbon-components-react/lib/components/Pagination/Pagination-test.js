  ...
  describe('renders as expected', function () {
    ...
    describe('pagination paging container', function () {
      ...
      it('should disable forward navigation for the last page', function () {
        var smallPage = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Pagination.default, {
          className: "extra-class",
          pageSizes: [100],
          totalItems: 50
        }));
      ...
      describe('pagination paging container when total pages unknown', function () {
        ...
        it('should hide text input if disabled', function () {
          var noTextInput = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Pagination.default, {
            pageSizes: [100],
            pagesUnknown: true,
            disabled: true
          }));
        ...
        it('should append `pagination__button--no-index` class if input is disabled', function () {
          ...
          var forwardButton = pagination.find(".".concat(prefix, "--pagination__button--forward")).first();
          var backwardButton = pagination.find(".".concat(prefix, "--pagination__button--backward")).first();
    ...
    it('should render with ref', function () {
      ...
      (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Pagination.default, {
        pageSizes: [10],
        totalItems: 5,
        forwardedRef: ref
      }));
      expect(ref.current).toHaveClass("".concat(prefix, "--pagination"));
    });
  });
});