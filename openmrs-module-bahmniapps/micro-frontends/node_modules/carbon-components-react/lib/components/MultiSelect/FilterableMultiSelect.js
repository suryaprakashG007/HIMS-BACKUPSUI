        ...
        return /*#__PURE__*/_react.default.createElement(_Selection.default, {
          ...
          render: function render(_ref2) {
            ...
            return /*#__PURE__*/_react.default.createElement(_downshift.default, (0, _extends2.default)({}, (0, _createPropAdapter.mapDownshiftProps)(downshiftProps), {
              ...
              var className = (0, _classnames.default)("".concat(prefix, "--multi-select"), "".concat(prefix, "--combo-box"), "".concat(prefix, "--multi-select--filterable"), [enabled ? null : containerClassName], (_cx5 = {}, (0, _defineProperty2.default)(_cx5, "".concat(prefix, "--multi-select--invalid"), invalid), (0, _defineProperty2.default)(_cx5, "".concat(prefix, "--multi-select--invalid--focused"), invalid && _this2.state.inputFocused), (0, _defineProperty2.default)(_cx5, "".concat(prefix, "--multi-select--open"), isOpen), (0, _defineProperty2.default)(_cx5, "".concat(prefix, "--multi-select--inline"), inline), (0, _defineProperty2.default)(_cx5, "".concat(prefix, "--multi-select--selected"), selectedItem.length > 0), (0, _defineProperty2.default)(_cx5, "".concat(prefix, "--multi-select--filterable--input-focused"), _this2.state.inputFocused), _cx5));
              ...
              var inputProps = getInputProps({
                ...
                onKeyDown: function onKeyDown(event) {
                  ...
                  if (!disabled) {
                    if ((0, _keyboard.match)(event, _keyboard.keys.Delete) || (0, _keyboard.match)(event, _keyboard.keys.Escape)) {
                      if (isOpen) {
                        _this2.handleOnMenuChange(true);
