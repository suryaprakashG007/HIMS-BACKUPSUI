...
var render = function render(props) {
  return (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_OverflowMenuItem.default, (0, _extends2.default)({
    closeMenu: jest.fn()
  }, props)));
};
...
describe('OverflowMenuItem', function () {
  describe('Renders as expected', function () {
    ...
    it('should have the correct class when hasDivider is true', function () {
      ...
      expect(wrapper.childAt(0).hasClass("".concat(prefix, "--overflow-menu--divider"))).toEqual(true);
    });
