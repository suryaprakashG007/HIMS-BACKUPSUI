...
describe('NumberInput', function () {
  describe('should render as expected', function () {
    ...
    beforeEach(function () {
      ...
      var iconTypes = [Subtract16, Add16];
  ...
  describe('events', function () {
    ...
    describe('enabled numberInput', function () {
      ...
      it('should increase by the value(decimal) of step', function () {
        wrapper.setProps({
          step: 10,
          value: 0.01
        }); // Enzyme doesn't seem to allow state() in a forwardRef-wrapped class component

        expect(wrapper.find('NumberInput').instance().state.value).toEqual(0.01);
        upArrow.simulate('click'); // Enzyme doesn't seem to allow state() in a forwardRef-wrapped class component

        expect(wrapper.find('NumberInput').instance().state.value).toEqual(10.01);
        upArrow.simulate('click');
        expect(wrapper.find('NumberInput').instance().state.value).toEqual(20.01);
        upArrow.simulate('click');
        expect(wrapper.find('NumberInput').instance().state.value).toEqual(30.01);
        upArrow.simulate('click');
        expect(wrapper.find('NumberInput').instance().state.value).toEqual(40.01);
      });
      ...
      it('should decrease by the value(decimal) of step', function () {
        wrapper.setProps({
          step: 10,
          value: 50.01
        }); // Enzyme doesn't seem to allow state() in a forwardRef-wrapped class component

        expect(wrapper.find('NumberInput').instance().state.value).toEqual(50.01);
        downArrow.simulate('click'); // Enzyme doesn't seem to allow state() in a forwardRef-wrapped class component
