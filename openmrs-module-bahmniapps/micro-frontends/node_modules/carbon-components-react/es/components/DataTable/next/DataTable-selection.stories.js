...
import DataTable, { Table, TableBody, TableCell, TableContainer, TableHead, TableHeader, TableRow, TableSelectAll, TableSelectRow } from '..';
...
export var Usage = function Usage(args) {
...
export var WithRadioSelection = function WithRadioSelection(args) {
  return /*#__PURE__*/React.createElement(DataTable, _extends({
    rows: rows,
    headers: headers,
    radio: true
...
export var WithSelectionAndSorting = function WithSelectionAndSorting(args) {
  return /*#__PURE__*/React.createElement(DataTable, _extends({
    rows: rows,
    headers: headers,
    isSortable: true
