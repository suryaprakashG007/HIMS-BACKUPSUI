...
import DataTable, { Table, TableBody, TableCell, TableContainer, TableExpandHeader, TableExpandRow, TableExpandedRow, TableHead, TableHeader, TableRow } from '../..';
...
export var BatchExpansion = function BatchExpansion(args) {
  return /*#__PURE__*/React.createElement(DataTable, _extends({}, args, {
    rows: rows,
    headers: headers,
