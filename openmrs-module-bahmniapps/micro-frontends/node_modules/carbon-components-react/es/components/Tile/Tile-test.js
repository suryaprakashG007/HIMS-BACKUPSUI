...
describe('Tile', function () {
  ...
  describe('Renders clickable tile as expected', function () {
    var wrapper = mount( /*#__PURE__*/React.createElement(ClickableTile, {
      className: "extra-class"
    }, /*#__PURE__*/React.createElement("div", {
      className: "child"
    }, "Test")));
  ...
  describe('Renders selectable tile as expected', function () {
    ...
    it('supports light version', function () {
      ...
      expect(wrapper.props().light).toEqual(false);
      expect(wrapper.find('div').at(0).hasClass('bx--tile--light')).toEqual(false);
      wrapper.setProps({
        light: true
      });
      expect(wrapper.props().light).toEqual(true);
      expect(wrapper.find('div').at(0).hasClass('bx--tile--light')).toEqual(true);
    });
    ...
    it('should have no AC violations', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _render = render( /*#__PURE__*/React.createElement("main", null, /*#__PURE__*/React.createElement(SelectableTile, {
                id: "tile-1",
                name: "tiles",
                value: "selectable"
              }, "Selectable"))), container = _render.container;
              _context.next = 3;
              return expect(container).toHaveNoACViolations('SelectableTile');
