...
var _ToggleSmall = _interopRequireDefault(require("../ToggleSmall/ToggleSmall.Skeleton"));
...
describe('ToggleSmall', function () {
  ...
  describe('Renders as expected', function () {
    ...
    var wrapper;
    beforeEach(function () {
      wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(ToggleSmall, {
        id: "toggle-1",
  ...
  it('toggled prop sets checked prop on input', function () {
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(ToggleSmall, {
      id: "test",
      "aria-label": "test label",
      toggled: true
    }));
...
describe('ToggleSmallSkeleton', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_ToggleSmall.default, null));
    var input = wrapper.find('input');
    var toggleLabel = wrapper.find(".".concat(prefix, "--toggle__label"));
