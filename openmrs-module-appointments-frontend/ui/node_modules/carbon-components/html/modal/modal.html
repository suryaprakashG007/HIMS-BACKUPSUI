...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-6ao4xp6c3e">Show
  modal</button>

<div data-modal id="modal-6ao4xp6c3e" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-6ao4xp6c3e-label" aria-describedby="modal-6ao4xp6c3e-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-6ao4xp6c3e-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-6ao4xp6c3e-heading">Modal heading</p>
