...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-pp5ckmdnmgm">Show
  modal</button>

<div data-modal id="modal-pp5ckmdnmgm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-pp5ckmdnmgm-label" aria-describedby="modal-pp5ckmdnmgm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-pp5ckmdnmgm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-pp5ckmdnmgm-heading">Modal heading</p>
