...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-f2n0623fdzm">Show
  modal</button>

<div data-modal id="modal-f2n0623fdzm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-f2n0623fdzm-label" aria-describedby="modal-f2n0623fdzm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-f2n0623fdzm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-f2n0623fdzm-heading">Modal heading</p>
