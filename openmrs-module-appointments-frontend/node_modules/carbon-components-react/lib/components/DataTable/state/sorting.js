...
exports.initialSortState = exports.getSortedState = exports.getNextSortState = exports.getNextSortDirection = void 0;
Object.defineProperty(exports, "sortStates", {
  enumerable: true,
  get: function get() {
    return _sortStates.sortStates;
  }
});

var _sortStates = require("./sortStates");
...
var initialSortState = _sortStates.sortStates.NONE;
/**
...
var getNextSortDirection = function getNextSortDirection(prevHeader, header, prevState) {
  ...
  if (prevHeader === header) {
    ...
    // NONE -> ASC -> DESC -> NONE
    if (prevState === 'NONE') {
      return _sortStates.sortStates.ASC;
    }

    if (prevState === 'ASC') {
      return _sortStates.sortStates.DESC;
    }

    return _sortStates.sortStates.NONE;
...
var getSortedState = function getSortedState(props, state, key, sortDirection) {
  ...
  var nextRowIds = sortDirection !== _sortStates.sortStates.NONE ? (0, _sorting.sortRows)({
    rowIds: rowIds,
    cellsById: cellsById,
