...
var ToggleSmallSkeleton = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2.default)(ToggleSmallSkeleton, _React$Component);

  var _super = _createSuper(ToggleSmallSkeleton);

  function ToggleSmallSkeleton() {
    (0, _classCallCheck2.default)(this, ToggleSmallSkeleton);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(ToggleSmallSkeleton, [{
    key: "render",
...
(0, _defineProperty4.default)(ToggleSmallSkeleton, "propTypes", (_defineProperty2 = {}, (0, _defineProperty4.default)(_defineProperty2, 'aria-label', _propTypes.default.string.isRequired), (0, _defineProperty4.default)(_defineProperty2, "className", _propTypes.default.string), (0, _defineProperty4.default)(_defineProperty2, "id", _propTypes.default.string), (0, _defineProperty4.default)(_defineProperty2, "labelText", _propTypes.default.string), _defineProperty2));
(0, _defineProperty4.default)(ToggleSmallSkeleton, "defaultProps", (0, _defineProperty4.default)({}, 'aria-label', 'Toggle is loading'));