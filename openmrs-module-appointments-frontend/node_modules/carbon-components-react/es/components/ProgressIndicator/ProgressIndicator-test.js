...
describe('ProgressIndicator', function () {
  describe('Renders as expected', function () {
    var progress = /*#__PURE__*/React.createElement(ProgressIndicator, {
    ...
    describe('ProgressStep', function () {
      ...
      describe('incomplete', function () {
        it('should render any incomplete ProgressSteps with correct className', function () {
          expect(mountedList.find(ProgressStep).at(5).children().hasClass("".concat(prefix, "--progress-step--incomplete"))).toEqual(true);
        });
        it('should render any incomplete ProgressSteps with correct props', function () {
...
describe('ProgressIndicatorSkeleton', function () {
  describe('Renders as expected', function () {
    var wrapper = shallow( /*#__PURE__*/React.createElement(ProgressIndicatorSkeleton, null));
