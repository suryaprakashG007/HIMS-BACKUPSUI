...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-0ku5mp02hq0j">Show
  modal</button>

<div data-modal id="modal-0ku5mp02hq0j" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-0ku5mp02hq0j-label" aria-describedby="modal-0ku5mp02hq0j-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-0ku5mp02hq0j-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-0ku5mp02hq0j-heading">Modal heading</p>
