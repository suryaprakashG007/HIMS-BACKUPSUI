...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1d49ormfgyq">Show
  modal</button>

<div data-modal id="modal-1d49ormfgyq" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1d49ormfgyq-label" aria-describedby="modal-1d49ormfgyq-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1d49ormfgyq-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1d49ormfgyq-heading">Modal heading</p>
