...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-8svp3ee6z7p">Show
  modal</button>

<div data-modal id="modal-8svp3ee6z7p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-8svp3ee6z7p-label" aria-describedby="modal-8svp3ee6z7p-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-8svp3ee6z7p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-8svp3ee6z7p-heading">Modal heading</p>
