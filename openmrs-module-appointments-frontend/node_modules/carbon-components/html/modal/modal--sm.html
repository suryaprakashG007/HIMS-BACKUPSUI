...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jvm3rtofr7">Show
  modal</button>

<div data-modal id="modal-jvm3rtofr7" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jvm3rtofr7-label" aria-describedby="modal-jvm3rtofr7-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jvm3rtofr7-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jvm3rtofr7-heading">Modal heading</p>
