...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-2pbdmew80pp">Show
  modal</button>

<div data-modal id="modal-2pbdmew80pp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-2pbdmew80pp-label" aria-describedby="modal-2pbdmew80pp-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-2pbdmew80pp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-2pbdmew80pp-heading">Modal heading</p>
