...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-yug2cbk5q0g">Show
  modal</button>

<div data-modal id="modal-yug2cbk5q0g" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-yug2cbk5q0g-label" aria-describedby="modal-yug2cbk5q0g-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-yug2cbk5q0g-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-yug2cbk5q0g-heading">Modal heading</p>
